  ...
  return (
    <section className="panel">
      <div className="panel-header">
        ...
        <p>Linha do tempo dos momentos marcantes do clã.</p>
      </div>
              ...
              <div className="history-content">
                ...
                {canEdit && (
                  <div className="history-actions">
                    <button type="button" className="ghost" onClick={() => openEdit(record)}>
                      Editar
                    </button>
      ...
      {canEdit && showForm && (
        <div className="history-modal-overlay" onClick={closeForm}>
          <div className="history-modal" onClick={(e) => e.stopPropagation()}>
            <div className="panel-header">
              <h2>{editingHistoryId ? 'Editar registro' : 'Novo registro'}</h2>
